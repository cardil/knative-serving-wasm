...
import (
	...
	wasm "github.com/cardil/knative-serving-wasm/pkg/client/informers/externalversions/wasm"
...
func (f *sharedInformerFactory) Wasm() wasm.Interface {
	return wasm.New(f, f.namespace, f.tweakListOptions)
}
