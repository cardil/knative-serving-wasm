...
import (
	...
	versionedscheme "github.com/cardil/knative-serving-wasm/pkg/client/clientset/versioned/scheme"
	client "github.com/cardil/knative-serving-wasm/pkg/client/injection/client"
	wasmmodule "github.com/cardil/knative-serving-wasm/pkg/client/injection/informers/wasm/v1alpha1/wasmmodule"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "wasmmodule-controller"
	defaultFinalizerName       = "wasmmodules.wasm.serving.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	wasmmoduleInformer := wasmmodule.Get(ctx)

	lister := wasmmoduleInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "wasm.serving.knative.dev.WasmModule"),
	)
